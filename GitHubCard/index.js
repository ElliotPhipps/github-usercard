...
const followersArray = [
  ...
  `https://api.github.com/users/EricFerguson76`,
...
function gitUserCard(object) {
  ...
  names.textContent = object.name;

  usernames.textContent = object.login;

  locations.textContent = `Location: ${object.location}`;
  ...
  bios.textContent = `Bio: ${object.bio}`;
  ...
  profiles.appendChild(gitAddress);
